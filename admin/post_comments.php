...
<input type="submit" name="submit" class="btn btn-success" value="Potvrdi">
 ...
 <td><input class='checkBoxes' type='checkbox' name='checkBoxArray[]' value='<?php echo $comment_id; ?>'></td>
        ...
        echo "<td><a href='post_comments.php?approve=$comment_id&post=$comment_post_id'><i class='fa fa-check-circle' aria-hidden='true'></i>&nbsp;Dozvoli</a></td>";
        echo "<td><a href='post_comments.php?unapprove=$comment_id&post=$comment_post_id'><i class='fa fa-times-circle' aria-hidden='true'></i>&nbsp;Zabrani</a></td>";
        echo "<td><a href='post_comments.php?delete=$comment_id&post=$comment_post_id'><i class='fa fa-trash' aria-hidden='true'></i>&nbsp;Izbriši</a></td>";
        echo "</tr>";
